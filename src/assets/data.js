export default{
    projects: {
        0: {
            ...
            desc: "Flappy bird clone in C++ using SFML as coursework assignment",
        ...
        1: {
            title: "Atom.ez",
            desc: "Application for learning chemical elements and interacting with them to create compounds",
            detail: <ul class="list-disc ml-4 text-gray-600">
                        <li>Developed an native Android chemistry application in Java</li>
        ...
        3: {
            ...
            desc: "A webiste that simulates and visualizes how turing machine works",
            detail: <ul class="list-disc ml-4 text-gray-600">
        ...
        5: {
            ...
            desc: "Developed my personal website to present resume and portfolio",
            detail: <ul class="list-disc ml-4 text-gray-600">
                        <li>My personal website to present my resume and portfolio</li>
                        <li>Developed using React.js and TailwindCSS for styling</li>
    ...
    works: {
        0: {
            title: "Cabble",
            desc: "A social media to make collaboration project easier",
            detail: <ul class="list-disc ml-4 text-gray-600">
                        <li>A social media to collaborate on an open-source project</li>
                        <li>Developed in Kotlin with the team by using Firebase</li>
        ...
        1: {
            title: "SayFine",
            desc: "Android application to manage restaurant and connect with customer",
            detail: <ul class="list-disc ml-4 text-gray-600">
